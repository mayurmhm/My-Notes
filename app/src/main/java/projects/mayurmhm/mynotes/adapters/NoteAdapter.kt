package projects.mayurmhm.mynotes.adapters
...
import projects.mayurmhm.mynotes.databinding.NoteItemBinding
import projects.mayurmhm.mynotes.model.NoteResponse

// note adapter class to handle data
    ...
    inner class NoteViewHolder(private val binding: NoteItemBinding) :
        ...
        fun bind(note: NoteResponse) {
            ...
            binding.root.setOnClickListener {
                // send selected note when clicked
                onNoteClicked(note)
            }
        }
